...
const EditProject: React.FC = () => {
    return (
        <div className="shadow-[0px 4px 12px rgba(0,0,0,0.1)]">
        <div className="rounded-t-lg bg-[#27272A] h-11">
        </div>
        <div className="rounded-b-lg h-[504px] bg-[#18181B]">
            <div className="flex">
                <div className="flex-1 flex flex-col gap-4 mt-6 ml-6">
                    <div className="flex gap-4">
                        <div className="max-w-[137px] font-semibold flex flex-col gap-1">
                            <label>Name</label>
                            <Input/>
                        </div>
